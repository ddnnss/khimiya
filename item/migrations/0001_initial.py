    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_description', models.TextField(blank=True, null=True, verbose_name='Краткое описание товара (отображается в карточке товара) (если оставить пустым, то будет взято 10 первых слов из описания товара)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('volume', models.DecimalField(db_index=True, decimal_places=2, default=0, max_digits=4, verbose_name='Объем')),
                ('price', models.DecimalField(db_index=True, decimal_places=2, default=0, max_digits=6, verbose_name='Цена')),
                ('item', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='item.Item', verbose_name='Товар')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiry', models.DateTimeField(default=datetime.datetime(2019, 9, 15, 19, 45, 54, 837242, tzinfo=utc), verbose_name='Срок действия безлимитного кода')),
            ],
            options={
