# Generated by Django 2.2.3 on 2019-09-05 06:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(db_index=True, decimal_places=2, default=0, max_digits=6, verbose_name='Цена за литр')),
                ...
                ('page_keywords', models.TextField(blank=True, null=True, verbose_name='Keywords SEO')),
                ('description', models.TextField(blank=True, null=True, verbose_name='Описание товара (отображается на странице товара)')),
                ('short_description', models.TextField(blank=True, null=True, verbose_name='Краткое описание товара (отображается в карточке товара) (если оставить пустым, то будет взято 15 первых слов из описания товара)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiry', models.DateTimeField(default=datetime.datetime(2019, 9, 5, 6, 4, 11, 634730, tzinfo=utc), verbose_name='Срок действия безлимитного кода')),
            ],
            options={
